...
(function () {
  ...
  var CHAPTERS = [
    ...
    { n: 22, t: '接收 Webhook',          d: '别人调你，而你控制不了他' },
    { n: 23, t: '实时通信',              d: '轮询、SSE 与 WebSocket' },
    { n: 24, t: '可观测性',              d: '让系统能自己说出哪里不对' },
    { n: 25, t: '调试',                 d: '定位问题的方法与工具', part: '第五部分 · 上线与维护' },
    { n: 26, t: '上线',                 d: '域名、DNS 与各平台部署' },
    { n: 27, t: '维护',                 d: '让项目活过三年' },
    { n: 28, t: '更多资源',             d: '文档、社区与继续深入的路线' }
  ];
