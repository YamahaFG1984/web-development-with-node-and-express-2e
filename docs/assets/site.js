...
(function () {
  ...
  var CHAPTERS = [
    ...
    { n: 15, t: '路由深入',             d: '路由器原理、参数、分组与子域名' },
    { n: 16, t: 'REST API 与 JSON',     d: 'API 设计、错误、CORS、RPC 与 OpenAPI' },
    { n: 17, t: '单页应用',             d: 'React SPA + Hono API 与 HonoX' },
    { n: 18, t: '静态资源',             d: 'serveStatic、CDN 与缓存策略' },
    { n: 19, t: '安全',                 d: 'HTTPS、安全响应头、CSRF、JWT 与 OAuth' },
    { n: 20, t: '集成第三方 API',        d: 'fetch、天气、地理编码与缓存' },
    { n: 21, t: '并发与数据一致性',      d: '本地跑得好好的，一上线就出事', part: '第四部分 · 系统会在哪里出问题' },
    { n: 22, t: '后台任务与队列',        d: '把慢操作移出请求路径' },
    { n: 23, t: '接收 Webhook',          d: '别人调你，而你控制不了他' },
    { n: 24, t: '实时通信',              d: '轮询、SSE 与 WebSocket' },
    { n: 25, t: '可观测性',              d: '让系统能自己说出哪里不对' },
    { n: 26, t: '调试',                 d: '定位问题的方法与工具', part: '第五部分 · 上线与维护' },
    { n: 27, t: '上线',                 d: '域名、DNS 与各平台部署' },
    { n: 28, t: '维护',                 d: '让项目活过三年' },
    { n: 29, t: '更多资源',             d: '文档、社区与继续深入的路线' }
  ];
